...
```javascript
import mskunary4d from 'https://cdn.jsdelivr.net/gh/stdlib-js/array-base-mskunary4d@v0.1.1-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/array-base-mskunary4d/actions/workflows/test.yml/badge.svg?branch=v0.1.1
[test-url]: https://github.com/stdlib-js/array-base-mskunary4d/actions/workflows/test.yml?query=branch:v0.1.1
